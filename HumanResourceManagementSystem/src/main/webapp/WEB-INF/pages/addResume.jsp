...
<body>
    <form action="addResume" method="post">
        简历名：  <input id="rname" type="text" name="rname"/><br/>
        姓名：    <input id="name" type="text" name="name"/><br/>
        性别：    <input id="sex" type="text" name="sex"/><br/>
        出生年月：<input id="birth" type="date" name="birth"/><br/>
        毕业学校：<input id="school" type="text" name="school"/><br/>
        民族：    <input id="nation" type="text" name="nation"/><br/>
        毕业时间：<input id="graduationTime" type="date" name="graduationTime"/><br/>
        工作经验：<input id="workEXP" type="text" name="workEXP"/><br/>
        户籍所在地：<input id="birthPlace" type="text" name="birthPlace"/><br/>
        ...
        邮箱地址：<input id="email" type="text" name="email"/><br/>
