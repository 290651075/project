...
<form action="updateTR1" method="post">
    ...
    培训开始时间:<input id="start" type="date" name="start" value="${DateAndString.dateToString(sessionScope.training.start)}"/><br/>
    培训结束时间:<input id="end" type="date" name="end" value="${DateAndString.dateToString(sessionScope.training.end)}"/><br/>
